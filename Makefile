...
OFILES = gba.o font.o draw.o logic.o main.o images/StartScreen.o images/character.o images/characterback.o images/characterleft.o images/characterright.o images/Obackground.o images/Temp_gameover.o images/Gameover.o images/Xbackground.o images/Gamewon.o images/Instructions.o images/Win_Animation.o images/WinScreen.o
